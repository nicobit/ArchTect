...
The authoritative grammar used by ArchTect is in `frontend/src/lib/dsl/grammar.txt` inside the extension source. The canonical language reference for Structurizr DSL is at [structurizr.com/help/dsl](https://structurizr.com/help/dsl).
